                              ...
                              <div className="content-main mt-10">
                                  ...
                                  <div className="row mt-70">
                                      ...
                                      <div className="col-lg-8 col-md-8">
                                          ...
                                          <p className="font-md color-grey-500 mb-10 pl-20">These terms and conditions may be modified at any time. Users are encouraged to periodically review the terms and conditions (along with the privacy statement) for any updates. The latest terms will apply each time the Website is accessed.</p>
                                          
                                          <h4 className="color-brand-1 mb-10" id="PaymentandFees">Personal Information</h4>
                                          <p className="font-md color-grey-500 mb-10 pl-20">Any personal information collected through the Website will be used by our privacy statement.</p>
                                          ...
                                          <p className="font-md color-grey-500 mb-20 pl-20">Please read this section carefully as it outlines the limitations of Cambridge Conveyancing's liability. Nothing in these terms limits or excludes liability for death or personal injury due to negligence or fraud. To the fullest extent permitted by law, Cambridge Conveyancing excludes all conditions, warranties, 
